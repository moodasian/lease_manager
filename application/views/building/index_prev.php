...
<main>
	...
	<section id="BuildingTitle" class="ls-detail-title">
		...
		<div class="ls-detail-title__header">
			...
			<h6 style="margin-top: 8px">건물 관리</h6>
		</div>
		<!-- 건물등록 버튼 -->
		...
		<!-- 건물등록 검색 폼 -->
		<form id="BuildingTitleSearch" class="ls-detail-title__form" action="#">
...
<section class="ls-modal">
	<div class="ls-modal-body">
		...
		<div class="modal-body__title">
			<h6><strong>건물 신규 등록하기</strong></h6>
		...
		<div class="modla-body__detail">
			<form style="font-size: 0;">
				...
				<!-- 객실 개수 -->
				<label for="LsBuildingRoomNum" class="ls-label">객실 개수</label>
				<input id="LsBuildingRoomNum" class="ls-form" type="number" placeholder="객실 개수를 입력하세요"/>

				<!-- 건물주소 -->
				<label for="LsBuildingZip" class="ls-label">건물 주소</label>
				<input id="LsBuildingZip" class="ls-form zip" type="text" placeholder="우편번호"/>
				<button id="LsBuildingZipSearch" type="button" class="ls-default-button--m zip-button" type="submit">주소 검색하기</button>
